...
//for sending an ACK paket with given seq number, 
  ...
  // After sending ACK for EOT, the receiver briefly waits to handle possible duplicate EOT packets.
  // If the sender did not receive the EOT ACK (due to ACK loss), it will resend the EOT.
  // During this short period, the receiver listens for duplicate EOT packets and re-sends the ACK.
